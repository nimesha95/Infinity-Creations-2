...
class AdminController extends Controller
{
    ...
    {
        $currOrd = DB::select("select order_id,email,order_obj,total,date,User_u_id from orders");
    ...
    public function postAdditems(Request $request)
    {
        ...
        DB::insert("insert into product (pro_id,name,type,price,pricing_unit,availability,quantity,discount,item_description,img1,img2,img3,thumb) values (?,?,?,?,?,?,?,?,?,?,?,?,?)",
            [$proid, $name, $type, $price, $unit, $availability,$quantity, $discount, $description, $img1, $img2, $img3, $thumb]);
