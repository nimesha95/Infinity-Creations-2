...
//        Route::get('/salary_calc/{id}', [
//            'uses' => 'AdminController@calculateSalary',
//            'as' => 'admin.calc_sal'
//        ]);
//
//        Route::get('/get_id', [
//            'uses' => 'AdminController@getId',
//            'as' => 'admin.get_id'
//        ]);
//
//        Route::get('/get_attendance/{id}', [
//            'uses' => 'AdminController@getAttendance',
//            'as' => 'admin.get_attendance'
//        ]);

//        Route::get('/get_role/{id}', [
//            'uses' => 'AdminController@getRole',
//            'as' => 'admin.get_role'
//        ]);
//
//        Route::get('/get_salary/{id}', [
//            'uses' => 'AdminController@getSalary',
//            'as' => 'admin.get_salary'
//        ]);

//        Route::get('/emp_details/{id}', [
//            'uses' => 'AdminController@getEmployeeDetails',
//            'as' => 'admin.get_employee'
//        ]);
